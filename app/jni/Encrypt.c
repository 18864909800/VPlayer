 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_ashin_vplayer_ndk_NdkCalActivity_encryptPassword
 ...
 */
JNIEXPORT jstring JNICALL Java_com_ashin_vplayer_ndk_NdkCalActivity_encryptString
